...
return (new CustomEvent(event_name,(function (){var obj28618 = ({"detail":data});
return obj28618;
})()));
} else {
...
var f = (function (){var pred__28625 = cljs.core._EQ_;
var expr__28626 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28625.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28626))){
return ((function (pred__28625,expr__28626){
return (function (p1__28619_SHARP_){
return console.warn(p1__28619_SHARP_);
});
;})(pred__28625,expr__28626))
} else {
if(cljs.core.truth_(pred__28625.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28626))){
return ((function (pred__28625,expr__28626){
return (function (p1__28620_SHARP_){
return console.debug(p1__28620_SHARP_);
});
;})(pred__28625,expr__28626))
} else {
if(cljs.core.truth_(pred__28625.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28626))){
return ((function (pred__28625,expr__28626){
return (function (p1__28621_SHARP_){
return console.error(p1__28621_SHARP_);
});
;})(pred__28625,expr__28626))
} else {
return ((function (pred__28625,expr__28626){
return (function (p1__28622_SHARP_){
return console.log(p1__28622_SHARP_);
});
;})(pred__28625,expr__28626))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28629){
...
var eval_fn = cljs.core.get.call(null,map__28630__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28632_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__28634,(0),null);
var v = cljs.core.nth.call(null,vec__28634,(1),null);
...
}catch (e28639){if((e28639 instanceof Error)){
var e = e28639;
return not_found;
} else {
throw e28639;
...
//# sourceMappingURL=utils.js.map?rel=1581817895945
