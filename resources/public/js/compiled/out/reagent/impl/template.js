...
var G__26079 = o;
(G__26079[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__26080__delegate = function (args){
...
while (G__26081__i < G__26081__a.length) {G__26081__a[G__26081__i] = arguments[G__26081__i + 0]; ++G__26081__i;}
  args = new cljs.core.IndexedSeq(G__26081__a,0,null);
} 
return G__26080__delegate.call(this,args);};
...
return G__26080__delegate(args);
});
...
var G__26083 = o;
(G__26083[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__26084__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__26085__i < G__26085__a.length) {G__26085__a[G__26085__i] = arguments[G__26085__i + 0]; ++G__26085__i;}
  args = new cljs.core.IndexedSeq(G__26085__a,0,null);
} 
return G__26084__delegate.call(this,args);};
G__26084.cljs$lang$maxFixedArity = 0;
G__26084.cljs$lang$applyTo = (function (arglist__26086){
var args = cljs.core.seq(arglist__26086);
return G__26084__delegate(args);
});
...
var G__26088 = props;
var G__26088__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__26088,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26088);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__26088__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26089){
...
var props = map__26090__$1;
var class$ = cljs.core.get.call(null,map__26090__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__26090,map__26090__$1,props,class$){
return (function (c){
...
});})(map__26090,map__26090__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26092){
...
var on_write = cljs.core.get.call(null,map__26093__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__26093,map__26093__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__26093,map__26093__$1,on_write))
);
} else {
...
var G__26096 = jsprops;
(G__26096["defaultValue"] = value);

(G__26096["onChange"] = ((function (G__26096,v,value,on_change){
return (function (p1__26095_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26095_SHARP_);
});})(G__26096,v,value,on_change))
);
...
var vec__26099 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26099,(0),null);
var id = cljs.core.nth.call(null,vec__26099,(1),null);
var class$ = cljs.core.nth.call(null,vec__26099,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___26103 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___26103 == null)){
} else {
var key_26104 = temp__5724__auto___26103;
(jsprops["key"] = key_26104);
}
...
var temp__5724__auto___26105 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___26105 == null)){
} else {
var key_26106 = temp__5724__auto___26105;
reagent.impl.template.oset.call(null,jsprops,"key",key_26106);
}
...
var G__26107 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__26107["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26111){
...
break;
default:
var G__26118 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__26118;
continue;
...
var n__4607__auto___26120 = a.length;
var i_26121 = (0);
while(true){
if((i_26121 < n__4607__auto___26120)){
(a[i_26121] = reagent.impl.template.as_element.call(null,(a[i_26121])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___26123 = a.length;
var i_26124 = (0);
while(true){
if((i_26124 < n__4607__auto___26123)){
var val_26125 = (a[i_26124]);
if(((cljs.core.vector_QMARK_.call(null,val_26125)) && ((reagent.impl.template.key_from_vec.call(null,val_26125) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26124] = reagent.impl.template.as_element.call(null,val_26125));

var G__26126 = (i_26124 + (1));
i_26124 = G__26126;
continue;
} else {
}
...
var ctx = ({});
var vec__26127 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__26127,(0),null);
var derefed = cljs.core.nth.call(null,vec__26127,(1),null);
...
var G__26130 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26130) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__26130){
...
//# sourceMappingURL=template.js.map?rel=1581523631900
