...
var temp__5718__auto____$1 = (o27429["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27430 = temp__5718__auto____$1;
return (o27430["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26541__auto__ = f;
return (o__26541__auto__["toString"]).call(o__26541__auto__);
} else {
return "";
}
...
try{var o__26541__auto___27433 = t;
(o__26541__auto___27433["cljs$lang$ctorPrWriter"]).call(o__26541__auto___27433,t,writer);
}catch (e27432){var __27434 = e27432;
}
...
var char_code = (function (){var o__26541__auto__ = (new String(char$));
return (o__26541__auto__["charCodeAt"]).call(o__26541__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26541__auto__ = String;
return (o__26541__auto__["fromCharCode"]).call(o__26541__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27435 = num_code;
switch (G__27435) {
case (1):
return (185);
...
var o__26541__auto__ = String;
return (o__26541__auto__["fromCharCode"]).call(o__26541__auto__,superscript_code);
});
/**
...
}catch (e27437){var _e__26548__auto__ = e27437;
return false;
}})())){
...
var vec__27438 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27438,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o27441 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27441["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27442 = temp__5718__auto____$1;
return (o27442["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27445){
var vec__27446 = p__27445;
var ns_detector = cljs.core.nth.call(null,vec__27446,(0),null);
...
var G__27452 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27453 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27452;
remaining_tokens = G__27453;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27443){
var G__27444 = cljs.core.first.call(null,seq27443);
var seq27443__$1 = cljs.core.next.call(null,seq27443);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27444,seq27443__$1);
});
...
var vec__27457 = cljs.core.split_with.call(null,(function (p1__27456_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27456_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27457,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27457,(1),null);
...
var vec__27463 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27463,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27463,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27466 = cljs.core.rest.call(null,remaining_tokens);
var G__27467 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27466;
name_tokens = G__27467;
continue;
} else {
...
var vec__27470 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27470,(0),null);
var arity = cljs.core.nth.call(null,vec__27470,(1),null);
var vec__27473 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27473,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27473,(1),null);
var vec__27476 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27476,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27476,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27476,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27476,(3),null);
...
var vec__27482 = result;
var munged_ns = cljs.core.nth.call(null,vec__27482,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27482,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27482,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27482,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27482,(4),null);
var arity = cljs.core.nth.call(null,vec__27482,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__27486 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__27486,(0),null);
var args = cljs.core.nth.call(null,vec__27486,(1),null);
var vec__27489 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27489,(0),null);
var name = cljs.core.nth.call(null,vec__27489,(1),null);
...
var G__27492 = (arity + (1));
var G__27493 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27494){
var vec__27495 = p__27494;
var arity = cljs.core.nth.call(null,vec__27495,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27495,(1),null);
...
return cljs.core.get.call(null,arities,p1__27498_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27499_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27502){
var vec__27503 = p__27502;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27503,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27500){
var G__27501 = cljs.core.first.call(null,seq27500);
var seq27500__$1 = cljs.core.next.call(null,seq27500);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27501,seq27500__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27511__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27511__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27511__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27511__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27512 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27512,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27512,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27512,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27512,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27512,(4),null);
var arity = cljs.core.nth.call(null,vec__27512,(5),null);
...
var o__26541__auto__ = f;
return (o__26541__auto__["getBasis"]).call(o__26541__auto__);
});
/**
...
}catch (e27516){var _e__26548__auto__ = e27516;
...
var G__27517 = (obj[cljs.core.first.call(null,path)]);
var G__27518 = cljs.core.rest.call(null,path);
obj = G__27517;
path = G__27518;
continue;
} else {
...
return (function (accum,p__27519){
var vec__27520 = p__27519;
var bit = cljs.core.nth.call(null,vec__27520,(0),null);
var protocol = cljs.core.nth.call(null,vec__27520,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27523){
var vec__27524 = p__27523;
var ns = cljs.core.nth.call(null,vec__27524,(0),null);
var name = cljs.core.nth.call(null,vec__27524,(1),null);
var selector = cljs.core.nth.call(null,vec__27524,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27529,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27529,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27529,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27527_SHARP_){
return (obj[cljs.core.first.call(null,p1__27527_SHARP_)]);
});})(name,sorted_matches,vec__27529,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1581523633092
