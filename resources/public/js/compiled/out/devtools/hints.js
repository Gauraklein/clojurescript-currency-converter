...
var map__29575 = top_item;
var map__29575__$1 = (((((!((map__29575 == null))))?(((((map__29575.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29575.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__29575):map__29575);
var file = cljs.core.get.call(null,map__29575__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__29575__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__29575__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e29574){var _e = e29574;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___29577 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___29577)){
var seen_errors_29578 = temp__5718__auto___29577;
if(cljs.core.truth_(seen_errors_29578.has(self))){
} else {
seen_errors_29578.add(self);

var temp__5720__auto___29579 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___29579)){
var sense_29580 = temp__5720__auto___29579;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29580)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1581523635716
