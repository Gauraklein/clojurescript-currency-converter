...
var G__21934 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__21934;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__21935 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__21935,ch);
...
if(("\\" === ch__$1)){
var ch_21936__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_21936__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_21936__$2);
} else {
}
...
var G__21948 = cljs.core.conj_BANG_.call(null,a,form);
a = G__21948;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__21949 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__21950 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__21950;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__21949;
}});
/**
...
var vec__21957 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21957,(0),null);
var start_column = cljs.core.nth.call(null,vec__21957,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__21963,(0),null);
var start_column = cljs.core.nth.call(null,vec__21963,(1),null);
...
var vec__21966 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21966,(0),null);
var end_column = cljs.core.nth.call(null,vec__21966,(1),null);
...
var sb = (function (){var G__21969 = (new goog.string.StringBuffer());
G__21969.append(initch);
...
var G__21971 = (function (){var G__21970 = sb;
G__21970.append(ch);

return G__21970;
})();
var G__21972 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__21971;
ch = G__21972;
continue;
}
...
G__21976.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__21976;
})();
var G__21980 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__21979;
ch = G__21980;
continue;
...
break;
default:
var G__21981 = (function (){var G__21977 = sb;
G__21977.append(ch);

return G__21977;
})();
var G__21982 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__21981;
ch = G__21982;
continue;
...
var vec__21983 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21983,(0),null);
var end_column = cljs.core.nth.call(null,vec__21983,(1),null);
...
var vec__21986 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21986,(0),null);
var column = cljs.core.nth.call(null,vec__21986,(1),null);
...
var vec__21991 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21991,(0),null);
var column = cljs.core.nth.call(null,vec__21991,(1),null);
...
var vec__21996 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21996,(0),null);
var column = cljs.core.nth.call(null,vec__21996,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__22004 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22004,(0),null);
var end_column = cljs.core.nth.call(null,vec__22004,(1),null);
...
var G__22007 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__22007,true,null,opts,pending_forms);
...
var G__22008 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__22008)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__22008)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__22008)){
...
var _STAR_suppress_read_STAR__orig_val__22009 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__22010 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__22010;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__22009;
}});
...
var G__22011 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__22011,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__22011,rdr,first_line);
...
var G__22015 = matched;
var G__22016 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__22015;
finished = G__22016;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__22017 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__22018 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__22018;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__22017;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__22019 = cljs.tools.reader.arg_env;
var arg_env_temp_val__22020 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__22020;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__22021 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22021,"(");
...
var G__22022 = (i + (1));
var G__22023 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__22019;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__22024 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__22024);
...
var G__22025 = cljs.core.next.call(null,s__$1);
var G__22026 = ret;
s__$1 = G__22025;
r = G__22026;
continue;
...
var G__22027 = cljs.core.next.call(null,s);
var G__22028 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__22027;
key_vals = G__22028;
continue;
} else {
...
var gensym_env_orig_val__22032 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__22033 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__22033;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__22032;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__22034 = token;
var G__22034__$1 = (((G__22034 == null))?null:cljs.core.subs.call(null,G__22034,(1)));
var G__22034__$2 = (((G__22034__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22034__$1));
var G__22034__$3 = (((G__22034__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22034__$2));
var G__22034__$4 = (((G__22034__$3 == null))?null:cljs.core.symbol.call(null,G__22034__$3));
if((G__22034__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__22034__$4);
}
})():(function (){var G__22035 = token;
var G__22035__$1 = (((G__22035 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22035));
if((G__22035__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22035__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__22046,reader){
...
var eof = cljs.core.get.call(null,map__22047__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq22053){
var G__22054 = cljs.core.first.call(null,seq22053);
var seq22053__$1 = cljs.core.next.call(null,seq22053);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22054,seq22053__$1);
});


//# sourceMappingURL=reader.js.map?rel=1581523629044
