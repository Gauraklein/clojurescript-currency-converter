...
var G__21903 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__21903;
continue;
} else {
return ch;
...
var vec__21904 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__21904,(0),null);
return (match === s);
});
...
var len__4730__auto___21909 = arguments.length;
var i__4731__auto___21910 = (0);
while(true){
if((i__4731__auto___21910 < len__4730__auto___21909)){
args__4736__auto__.push((arguments[i__4731__auto___21910]));

var G__21911 = (i__4731__auto___21910 + (1));
i__4731__auto___21910 = G__21911;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq21907){
...
return (function() { 
var G__21912__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__21912 = function (rdr,var_args){
var _ = null;
...
while (G__21913__i < G__21913__a.length) {G__21913__a[G__21913__i] = arguments[G__21913__i + 1]; ++G__21913__i;}
  _ = new cljs.core.IndexedSeq(G__21913__a,0,null);
} 
return G__21912__delegate.call(this,rdr,_);};
G__21912.cljs$lang$maxFixedArity = 1;
G__21912.cljs$lang$applyTo = (function (arglist__21914){
var rdr = cljs.core.first(arglist__21914);
var _ = cljs.core.rest(arglist__21914);
return G__21912__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1581523628740
